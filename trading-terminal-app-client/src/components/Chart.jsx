...
const TradingChart = ({
  ...
  // Determine API endpoint based on market context
  const getApiEndpoint = useCallback((symbol, interval) => {
  ...
  const fetchChartData = useCallback(async () => {
    ...
    try {
      ...
      const endpoint = getApiEndpoint(symbol, selectedInterval);
  ...
  }, [symbol, selectedInterval, getApiEndpoint]);
  ...
  }, [symbol, height, handleResize, cleanupChart, fetchChartData]);
